...
def do_command():
    parser = argparse.ArgumentParser(description='operate daemon')
    parser.add_argument('operation', metavar='OPERATION', type=str,
                        help='Operation with daemon ' \
                             'Accepts any of these values: ' \
...
class Daemon(object):
    ...
    Usage: subclass the Daemon class and override the run(), sigterm() method
    """
    ...
    def create_pidfile(self):
        _path = os.path.dirname(self.pidfile)
    ...
    def sigterm(self, signum, frame):
        """
        You should override this method when you subclass Daemon.
        It will be called when recieve signal which is SIGTERM
        """
        raise NotImplementedError
